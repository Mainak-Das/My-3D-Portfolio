  ...
  return (
    <section className="relative z-20 bg-[#0b131c] min-h-screen py-32 px-4 md:px-12 overflow-hidden" id="journey">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[20%] w-[600px] h-[600px] bg-[#c74b13]/10 rounded-full blur-[120px]" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div ref={containerRef} className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-[2px] bg-linear-to-b from-[#1f1e33]/20 via-[#c74b13]/50 to-[#1f1e33]/20 transform md:-translate-x-1/2" />
