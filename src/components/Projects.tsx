...
const projects = [
    ...
    },
    {
        ...
        demo: "#",
        color: "from-[#1f1e33]/50 to-blue-600/20",
        hoverColor: "group-hover:from-[#1f1e33]/70 group-hover:to-blue-600/40",
        span: "md:col-span-1 md:row-span-1",
        mediaType: "image",
        // Reading/Books
    ...
    },
    {
        ...
        demo: "#",
        color: "from-[#c74b13]/30 to-red-600/20",
        hoverColor: "group-hover:from-[#c74b13]/50 group-hover:to-red-600/40",
        span: "md:col-span-1 md:row-span-1",
        mediaType: "image",
        // Color/Art
