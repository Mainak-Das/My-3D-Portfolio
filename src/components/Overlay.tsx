        ...
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
            ...
            >
                <div className="text-start">
                    <h1 className="text-4xl md:text-4xl font-semibold tracking-tight mb-4">Hi, I'm</h1>
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Mainak Das.</h1>
                    <p className="text-xl md:text-2xl font-light text-gray-300">Full Stack Developer & ML Enthusiast</p>
                </div>
            </motion.div>
            ...
            >
                <div className="max-w-2xl">
                    ...
                    <h2 className="text-5xl md:text-7xl font-bold leading-tight">Hi, I'm <br /><span className="text-[#c74b13]">Mainak Das.</span></h2>
                </div>
            </motion.div>
